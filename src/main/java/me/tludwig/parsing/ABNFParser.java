...
public class ABNFParser extends PEGrammar {
	...
	public void init() {
		...
		def("alternation",		seq(def("concatenation"), zeroOrMore(seq(zeroOrMore(def("c-wsp")), character('/'), zeroOrMore(def("c-wsp")), def("concatenation")))));
		def("concatenation",	seq(def("repetition"), zeroOrMore(seq(oneOrMore(def("c-wsp")), def("repetition")))));
		...
		def("bin-val",		seq(character('b'), oneOrMore(def("BIT")), opt(choice(oneOrMore(seq(character('.'), oneOrMore(def("BIT")))), seq(character('-'), oneOrMore(def("BIT")))))));
		def("dec-val",		seq(character('d'), oneOrMore(def("DIGIT")), opt(choice(oneOrMore(seq(character('.'), oneOrMore(def("DIGIT")))), seq(character('-'), oneOrMore(def("DIGIT")))))));
		def("hex-val",		seq(character('x'), oneOrMore(def("HEXDIG")), opt(choice(oneOrMore(seq(character('.'), oneOrMore(def("HEXDIG")))), seq(character('-'), oneOrMore(def("HEXDIG")))))));
