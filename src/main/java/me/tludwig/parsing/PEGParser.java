...
public class PEGParser extends PEGrammar {
	...
	public PEGParser() {
		...
		def("Expression",		seq(def("Sequence"), zeroOrMore(def("SLASH"), def("Sequence"))));
		...
		def("Literal",	choice(seq(character('\''), zeroOrMore(not(character('\'')), def("Char")), character('\''), def("Spacing")),
							   seq(character('"'), zeroOrMore(not(character('"')), def("Char")), character('"'), def("Spacing"))));
		def("Class",	seq(character('['), zeroOrMore(not(character(']')), choice(def("Range"), def("Char"))), character(']'), def("Spacing")));
		...
		def("Comment",			seq(character('#'), zeroOrMore(not(def("EndOfLine")), any()), def("EndOfLine")));
